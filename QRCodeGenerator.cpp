...
bool CQR_Encode::EncodeData(int nLevel, int nVersion, bool bAutoExtent, int nMaskingNo, char* lpsSource, int textlen, int ncSource)
{
	int i, j;
    ...
    int ncLength = ncSource > 0 ? ncSource : textlen;//strlen(lpsSource);
